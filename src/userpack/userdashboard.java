...
public class userdashboard extends javax.swing.JFrame {
    ...
    public userdashboard() {
     ...
     public void displayData(){
        ...
        try (ResultSet rsapp = dbc.getData("SELECT COUNT(*) AS total FROM tbl_jobs")) {
            if (rsapp.next()) {
                int allapp = rsapp.getInt("total"); 
                jobs.setText(""+allapp);
            }
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 170, 40));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagesdesign/9004799_arrow_direction_left_back_icon.png"))); // NOI18N
        ...
        jLabel12.setText("TOTAL JOBS");
        jLabel12.setOpaque(true);

        jobs.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jobs.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jobs.setText("00");
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addComponent(jobs, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
