...
public class crudapplicant extends javax.swing.JFrame {

  
    public crudapplicant() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(crudapplicant.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new crudapplicant().setVisible(true);
            }
        });
    }
